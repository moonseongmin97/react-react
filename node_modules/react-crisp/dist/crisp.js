...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_slicedToArray__ = __webpack_require__(5);
...
function usePrevious(value) {
  var ref = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_react__["useRef"])();
...
function pushCrisp(method, parameters) {
  if (Object.keys(parameters).length > 0) {
    var items = Object.entries(parameters);
    items.map(function (item) {
      var _item = __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_slicedToArray___default()(item, 2),
          key = _item[0],
          value = _item[1];
...
function Crisp(props) {
  var crispWebsiteId = props.crispWebsiteId,
      crispTokenId = props.crispTokenId,
      crispRuntimeConfig = props.crispRuntimeConfig,
      safeMode = props.safeMode,
      configuration = props.configuration,
      attributes = props.attributes;
  var previousCrispWebsiteId = usePrevious(crispWebsiteId);

  if (previousCrispWebsiteId && previousCrispWebsiteId !== crispWebsiteId) {
    throw Error("crispWebsiteId can't be changed");
  }

  var previousCrispTokenId = usePrevious(crispTokenId);

  if (previousCrispTokenId && previousCrispTokenId !== crispTokenId) {
    throw Error("crispTokenId can't be changed");
  }

  var previousCrispRuntimeConfig = usePrevious(crispRuntimeConfig);
  ...
  var previousSafeMode = usePrevious(safeMode);
  ...
  var scriptUrl = 'https://client.crisp.chat/l.js';
  var scripts = document.querySelector("script[src='".concat(scriptUrl, "']"));
  ...
  if (scripts === null) {
    ...
    global.CRISP_RUNTIME_CONFIG = crispRuntimeConfig; // We are good start Crisp
  ...
  return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react___default.a.Fragment, null);
}

Crisp.propTypes = {
  crispWebsiteId: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
  crispTokenId: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  crispRuntimeConfig: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.objectOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOfType([__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string, __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number, __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool, __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array])),
  attributes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.objectOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array),
  configuration: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.objectOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array),
  safeMode: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool
};
Crisp.defaultProps = {
  crispTokenId: '',
  crispRuntimeConfig: {},
